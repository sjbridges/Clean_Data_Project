...
# 5. Using 4, creates a second tidy data set with the average of each variable for each activity and each subject.
...
write.table(result, "tidy_data_set_on_averages.txt", row.name=FALSE)
